...
import { FaTachometerAlt, FaBook, FaFolderOpen, FaComments, FaProjectDiagram, FaCog, FaSignOutAlt } from 'react-icons/fa';
    ...
    return (
        <aside className="bg-[#281719] text-white w-64 min-h-screen flex flex-col fixed left-0 top-0 z-20 shadow-lg">
            ...
            <nav className="flex-1 flex flex-col gap-1 mt-6 px-2">
                ...
                <Link href="/dashboard/cursos" className="flex items-center gap-3 py-3 px-5 rounded-lg hover:bg-[#9BB61B] font-semibold transition">
                    <FaBook /> Cursos
                </Link>
                ...
                <Link href="/dashboard/projetos" className="flex items-center gap-3 py-3 px-5 rounded-lg hover:bg-[#9BB61B] font-semibold transition">
